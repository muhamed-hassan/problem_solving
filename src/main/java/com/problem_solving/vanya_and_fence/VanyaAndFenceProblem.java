...
class VanyaAndFenceProblem {

    int findTheMinimumPossibleValidWidthOfTheRoad(int numberOfFriends, int heightOfFence, int[] friendsHeights) {
        ...
        var minimumPossibleValidWidthOfTheRoad = 0;
