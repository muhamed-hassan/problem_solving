...
class LeftRotationProblemTest {
    ...
    @Test
    void testRotLeft_WhenParametersAreValid_ThenReturnTheRotatedArray() {
    ...
    void testRotLeft_WhenParametersAreInvalid_ThenThrowIllegalArgumentException(int[] a, int d) {
