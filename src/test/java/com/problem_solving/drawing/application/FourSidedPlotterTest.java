...
class FourSidedPlotterTest {

    List<PlottingPoint> generateHorizontalAxisPoints(int startFrom, int endAt, int y, Type type, char characterToBeDrawn) {
    ...
    List<PlottingPoint> generateVerticalAxisPoints(int startFrom, int endAt, int x, Type type, char characterToBeDrawn) {
